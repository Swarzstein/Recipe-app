...
RSpec.describe 'Inventory', type: :system do
    ...
    let!(:food_one) {Food.create name: 'Salad', measurement_unit: '1kg', price: 5}
    let!(:food_two) {Food.create name: 'Tomato', measurement_unit: '1kg', price: 5}
    let!(:food_three) {Food.create name: 'Potato', measurement_unit: '1kg', price: 5}
    let!(:food_four) {Food.create name: 'Carrot', measurement_unit: '1kg', price: 5}
    let!(:food_five) {Food.create name: 'Banana', measurement_unit: '1kg', price: 5}
    ...
    let!(:inventory_food_three) {InventoryFood.create inventory_id: inventory_one.id, food_id: food_three.id, quantity: 5}
    let!(:inventory_food_four) {InventoryFood.create inventory_id: inventory_two.id, food_id: food_four.id, quantity: 5}
    let!(:inventory_food_five) {InventoryFood.create inventory_id: inventory_two.id, food_id: food_five.id, quantity: 5}
